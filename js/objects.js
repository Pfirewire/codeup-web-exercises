(function() {
    ...
    for(let i = 0; i < shoppers.length; i++) {
        if(shoppers[i].amount > 200) {
            console.log(`${shoppers[i].name}'s subtotal is: $${shoppers[i].amount.toFixed(2)}. This qualifies for our 12% discount! ${shoppers[i].name}'s total is: $${(shoppers[i].amount * .88).toFixed(2)}.`);
        } else {
            console.log(`${shoppers[i].name}'s subtotal is: $${shoppers[i].amount.toFixed(2)}. This does not qualify for our discount. ${shoppers[i].name}'s total is: $${shoppers[i].amount.toFixed(2)}.`);
    ...
    for(let i = 0; i < books.length; i++) {
        ...
        // only add divider to books that have another afterwards
        if(i < books.length - 1){
            console.log(`---`);
        }
    }
    ...
    // console.log(createBook("Cat in the Hat", "Dr.", "Seuss"));
